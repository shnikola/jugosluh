class Collector
  ...
  def connect_to_album(source)
    ...
    album_by_title = Album.find_original_by_title(source.clean_title) if source.clean_title.present?
    ...
    source.update_attributes(album_id: (album_by_catnum || album_by_title).try(:id))    
  end
